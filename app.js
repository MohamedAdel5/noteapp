...
app.use((req, res, next) => {
	if(process.env.NODE_ENV !== "production"){
		...
		// res.setHeader("Access-Control-Allow-Origin", "http://www.notesapp.com");
		//It should allow only the frontend app. but "*" is used for development.
		res.setHeader("Access-Control-Allow-Origin", "*");
...
app.use(`${apiUrlBase}/notes`, noteRouter);
...
app.get(`/notes/:id`, function (req, res) {
	res.sendFile(`${frontendPath}/myNote.html`);
});
app.get(`/online-note/:id`, function (req, res) {
	res.sendFile(`${frontendPath}/onlineNote.html`);
});
